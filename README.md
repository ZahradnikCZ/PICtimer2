...
# How to use #
The program will ask you to set an oscilator frequency, which is frequency usually provided by internal oscilator, but you can use external oscilator for clocking the timers, so you need to specify that frequency.
